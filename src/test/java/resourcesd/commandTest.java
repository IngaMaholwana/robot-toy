...
class CommandTest {
    ...
    @Test
    void getLeftName() {
        Command test = new TurnCommand("left");
    ...
    @Test
    void getRightName() {
        Command test = new TurnCommand("right");
    ...
    void executeReplay() {
        ...
        assertEquals(expectedPosition, robot.getPosition());
        assertEquals("replayed 5 commands.", robot.getStatus().getMessage());
    }


    @Test
    void getMazerunName() {
        Command test = new MazeRunnerCommand("");
